...
def run_simulation(genomes, config, arg1, arg2):
    ...
    game_map = pygame.image.load(arg1).convert()  # Convert Speeds Up A Lot
...
if __name__ == "__main__":
    ...
    parser.add_argument('arg2', type=str, help='Description de l\'argument 2')

    # Analyser les arguments
    args = parser.parse_args()

    # Utiliser les arguments dans votre fonction principale
    arg1 = '../assets/' + args.arg1
    arg2 = args.arg2
    ...
    population.run(lambda genomes, config: run_simulation(genomes, config, arg1, arg2), 2)
